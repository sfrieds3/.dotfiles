...
abbr add 'git difftool'='git difftool -d'
...
abbr add kgpof='kubectl get pods --field-selector status.phase=Failed'
abbr add kgpor='kubectl get pods --field-selector status.phase=Running'
...
abbr add klof='kubectl logs --follow --timestamps'
abbr add klop='kubectl logs --follow --previous --timestamps'
abbr add klon='kubectl logs -f --namespace --timestamps'
abbr add kloal='kubectl logs --tail=-1 --prefix -l component=% --timestamps'
abbr add kloall='kubectl logs --tail=-1 --prefix --follow -l component=% --timestamps'
